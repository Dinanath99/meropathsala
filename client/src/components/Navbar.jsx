...
//   return (
//     <div className="h-16 bg-white border-b border-gray-200 fixed top-0 left-0 right-0 z-50 shadow-sm">
//       {/* Desktop Navbar */}
...
//           <Link to="/">
//             <h1 className="font-bold text-2xl text-gray-900 hover:text-blue-600 transition">
//               MeroPathshala
//             </h1>
//           </Link>
//         </div>
...
//         </Button>
//       </SheetTrigger>
//       <SheetContent side="right" className="flex flex-col bg-white text-gray-900">
